...
SCETOOL_FLAGS	?=	--self-app-version=0001000000000000  --sce-type=SELF --compress-data=TRUE --self-add-shdrs=TRUE --skip-sections=FALSE --key-revision=1 \
					--self-auth-id=10700003FF000001 --self-vendor-id=01000002 --self-fw-version=0003004000000000
...
SCETOOL_FLAGS	+=	--self-cap-flags 00000000000000000000000000000000000000000000003B0000000100000000
